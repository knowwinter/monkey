                        ...
                        <div class="imageUploadContainerInner">\
                            ...
                            <div class="mce-container imageUploadFormContainer" hidefocus="1" tabindex="-1">\
                                <div class="mce-container-body" style="padding-left: 20px;">\
                                    <label for="image-upload-area">选择文件</label>\
                                ...
                                <div class="mce-container-body" style="padding-left: 100px;">\
                                    <input type="radio" name="uploadtype" value="img" checked>图片插入</input>\
                                    <input type="radio" name="uploadtype" value="attachment" >附件插入</input>\
                                </div>\
                    ...
                    $('#uploadImageForm').ajaxSubmit({
                        ...
                        success: function(response){
                            ...
                            if (response.url) {
                                ...
                                if (response.uploadtype == 'img'){
                                    tpl = '<img src="%s" width="220"/>';
                                }else {

                                    tpl = '<a href="%s">' + response.o_filename + '</a>';
                                }
