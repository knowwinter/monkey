# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-02-12 23:14
...
class Migration(migrations.Migration):
    ...
    def forwards_func(apps, schema_editor):
        Menu_option = apps.get_model("das", "Menu_option")
        db_alias = schema_editor.connection.alias
        Menu_option.objects.using(db_alias).bulk_create([
            Menu_option(option_name=u'登录框', option_title="登录框",
                        ...
                        option_icon='icon-link', menu_id='1', option_level=1
                        )
        ])
    ...
    def reverse_func(apps, schema_editor):
        Menu_option = apps.get_model("das", "Menu_option")
        db_alias = schema_editor.connection.alias
        Menu_option.objects.using(db_alias).filter(option_name=u'登录框').delete()

    dependencies = [
        ('das', '0034_auto_20190212_2307'),
    ]
